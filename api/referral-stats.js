...
module.exports=async(req,res)=>{
 ...
 try{
  ...
  const {s,e}=range(req), sources={},devices={},hours={}, daily=[]; let views=0,buy=0,checkout=0,failures=0,purchases=0,revenue=0; const visitors=new Set(),sessions=new Set();
  for(let t=dayStart(s);t<e;t+=86400000){
   ...
   views+=get("views");buy+=get("buy_clicks");checkout+=get("checkout_views");failures+=get("payment_failures");purchases+=get("purchases");revenue+=get("revenue");
